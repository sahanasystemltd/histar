    ...
    <aside class="services__sidebar">
        <div class="sidebar__widget sidebar__widget-three">
            <div class="sidebar__cat-list-two sidebar__cat-list-three">
                <ul class="list-wrap">
                    <li>
                        <a href="it-software-services.php">IT Software Service <i class="flaticon-arrow-button"></i></a>
                    </li>
                    <li>
                        <a href="food-processing-constant.php">Food Processing Consultant <i class="flaticon-arrow-button"></i></a>
                    </li>
                    <li>
                        <a href="resource-augmentation.php">Resource Augmentation <i class="flaticon-arrow-button"></i></a>
                    </li>
                </ul>
            </div>
        </div>
