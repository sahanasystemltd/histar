                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6">
                                <div class="footer-widget">
                                    <div class="fw-logo mb-25">
                                        <a href="index.php"><img src="assets/img/logo/logo.png" alt="Histar" /></a>
                                    </div>
                                    <div class="footer-content">
                                        <p>Histar provides multi-domain solutions across technology, consulting, and workforce services—driving quality, scalability, and sustainable business growth.</p>
...
<!--                            </div>-->
                            <div class="col-lg-5">
                                <div class="copyright-text">
                                    <p>Copyright © <a href="index.php">Histar</a> | All Right Reserved</p>
